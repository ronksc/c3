...
class Woo_Ecommerce_Tracking_For_Google_And_Facebook {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action('admin_init', $plugin_admin, 'woo_ecommerce_tracking_settings');
		
		$this->loader->add_action( 'wp_ajax_add_plugin_user_wetfgf', $plugin_admin, 'wp_add_plugin_userfn' );
		$this->loader->add_action( 'wp_ajax_hide_subscribe_wetfgf', $plugin_admin, 'hide_subscribe_wetfgffn' );
        ...
        $this->loader->add_action('woocommerce_ecommerce_tracking_for_google_and_facebook_other_plugins', $plugin_admin, 'woocommerce_ecommerce_tracking_for_google_and_facebook_other_plugins');
        $this->loader->add_action('woocommerce_ecommerce_tracking_for_google_and_facebook_about', $plugin_admin, 'woocommerce_ecommerce_tracking_for_google_and_facebook_about');
...
/*		$this->loader->add_action('admin_init', $plugin_admin, 'welcome_free_ecommerce_tracking_screen_do_activation_redirect');
        //admin menu intilization hooks
        $this->loader->add_action('admin_menu', $plugin_admin, 'welcome_pages_screen_free_ecommerce_tracking');
        
        $this->loader->add_action('free_ecommerce_tracking_other_plugins', $plugin_admin, 'free_ecommerce_tracking_other_plugins');
        $this->loader->add_action('free_ecommerce_tracking_about', $plugin_admin, 'free_ecommerce_tracking_about');*/
