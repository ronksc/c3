...
<div class="xoo-qv-main-settings">
	...
	<div class="rate-plugin">If you like the plugin , please show your support by rating <a href="https://wordpress.org/support/view/plugin-reviews/quick-view-woocommerce" target="_blank">here.</a>
		<div class="donate-us"><a href="http://paypal.me/xootix"><span class="dashicons dashicons-heart" style="margin-right: 2px;"></span> Donate</a>
		</div>
	</div>

	<div class="plugin-support">
		Use <a href="http://xootix.com" target="_blank">Live Chat</a> for instant support.
	</div>
...
<div class="xoo-qv-sidebar">
	<div class="xoo-chat">
		...
		<span class="xoo-chtxt">Use <a href="http://xootix.com/product/woocommerce-quick-view-premium/">Live Chat</a></span>
	</div>
