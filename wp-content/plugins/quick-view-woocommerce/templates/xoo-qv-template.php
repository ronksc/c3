...
<div class="xoo-qv-nxt xooqv-arrow-right xoo-qv" qv-nxt-id ="<?php echo  esc_attr($product_id); ?>"></div>
<div class="xoo-qv-prev xooqv-arrow-left xoo-qv" qv-prev-id ="<?php echo  esc_attr($product_id); ?>"></div>
