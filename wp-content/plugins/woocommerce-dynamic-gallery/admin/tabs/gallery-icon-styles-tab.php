...
<?php
/*-----------------------------------------------------------------------------------
WC Dynamic Gallery Icon Styles Tab
...
class WC_Dynamic_Gallery_Icon_Styles_Tab extends WC_Dynamic_Gallery_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/gallery-icon-styles-settings.php' );
...
global $wc_dgallery_icon_styles_tab;
$wc_dgallery_icon_styles_tab = new WC_Dynamic_Gallery_Icon_Styles_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wc_dgallery_icon_styles_tab_manager() {
	global $wc_dgallery_icon_styles_tab;
	$wc_dgallery_icon_styles_tab->tab_manager();
}
