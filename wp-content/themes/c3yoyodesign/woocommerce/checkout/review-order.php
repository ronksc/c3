...
?>
<div class="table-responsive woocommerce-checkout-review-order-table-wrapper">
<table class="shop_table woocommerce-checkout-review-order-table">
	...
	<tfoot>
		...
		<tr class="cart-subtotal">
			<td colspan="2"><?php _e( 'Subtotal', 'woocommerce' ); ?></td>
		...
		<tr class="order-total">
			<td colspan="2"><?php _e( 'Total', 'woocommerce' ); ?></td>
